...
import { Tag, ShoppingBag, Settings as SettingsIcon, Bike, Power, AlertTriangle } from 'lucide-react'
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-4 px-6 py-4 rounded-2xl text-xs font-black uppercase tracking-widest transition-all duration-300 cursor-pointer group ${
                isActive 
