...
import { Tag, ShoppingBag, Settings as SettingsIcon, Bike, Power, AlertTriangle, Layers, ClipboardList, Ticket, UtensilsCrossed, Route } from 'lucide-react'
...
const tabs = [
  ...
  { id: 'delivery-routes', label: 'Rotas', icon: Route, path: '/admin/delivery-routes' },
